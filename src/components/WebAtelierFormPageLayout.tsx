...
export function WebAtelierFormPageLayout({ language, title, children }: WebAtelierFormPageLayoutProps) {
  const backLabel = language === 'hr' ? 'Natrag na Web Atelier' : 'Back to Web Atelier'
