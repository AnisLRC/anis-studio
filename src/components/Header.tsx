...
export default function Header({ language, onLanguageChange, cartItemCount, onCartClick }: HeaderProps) {
  ...
  return (
    <header className="py-3 fixed top-0 left-0 right-0 z-50 glass" style={{
      ...
      <div className="container flex items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-2">
            <a href="#lrc" className="btn-ghost">LRC</a>
            <a href="#interiors" className="btn-ghost">Interiors</a>
            <a href="#web" className="btn-ghost">Web</a>
